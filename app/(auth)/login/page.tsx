...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center pixel-grid-bg">
      <div className="pixel-glow-card rounded-xl p-8 w-full max-w-md bg-background/80 backdrop-blur border border-border/50">
        <h1 className="text-2xl font-display font-bold text-center mb-2">
          Welcome back
        </h1>
        <p className="text-kr-muted text-center text-sm mb-8">
          Sign in to your KvinnResume account
        </p>
        ...
        <p className="text-center text-sm mt-8 text-kr-muted">
